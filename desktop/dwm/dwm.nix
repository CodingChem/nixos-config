...
let
  ...
  dwmConfig = pkgs.replaceVars ./config.def.h {
...
{
  options.my.dwm = {
    enable = mkEnableOption "Dwm customization";
    terminal = mkOption {
      type = types.str;
      default = "kitty";
      description = "The terminal of choice (kitty, alacritty)";
    };
  };
